...
- os filmes mais assistidos na Netflix
...
- `bilheterias.html` com o **top 5 das maiores bilheterias mundiais em tabela (nome, ano, bilheteria)**
- `netflix.html` com o **top 5 filmes mais assistidos da Netflix em tabela (nome, ano, visualizações)**
...
git branch -M main 
git remote add origin https://github.com/Ernock-The-Knight/Piratex-TV.git
